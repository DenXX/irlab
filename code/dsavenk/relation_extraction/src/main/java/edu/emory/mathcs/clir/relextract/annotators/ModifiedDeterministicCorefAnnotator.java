...
public class ModifiedDeterministicCorefAnnotator implements Annotator {
    ...
    public ModifiedDeterministicCorefAnnotator(String annotatorClass, Properties props) {
        try {
    ...
    public void annotate(Annotation annotation){
        try {
            ...
            ModifiedRuleBasedCorefMentionFinder finder = new ModifiedRuleBasedCorefMentionFinder(allowReparsing);
