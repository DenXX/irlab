...
\hline
\end{tabular}
\caption{Average Recall (R), Precision (P), and F1 for combinations of Text2KB and STAGG using a simple heuristic based on the length of the answer list and Oracle upper bound}
