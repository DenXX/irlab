...
STAGG \cite{yih2014semantic} & 0.607 & \textbf{0.528} & \textbf{0.565} & \textbf{0.525}\\
...
\item{\textbf{STAGG}}: The current highest performing KBQA system~\cite{yih:ACL:2015:STAGG} as measured on the WebQuestions dataset.
\end{itemize}
