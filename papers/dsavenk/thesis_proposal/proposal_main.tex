...
% -------------------
\begin{abstract}
\section*{Question Answering With User Generated Content}
Denis Savenkov\\
...
In my thesis I develop new methods to improve the performance of question answering systems for solving users' information needs using various types of user generated content, such as text documents, curated knowledge bases, community question answering archives, and direct human contributions.
I first focus on improving performance of automatic question answering by better utilization of available structured and unstructured data sources.
Next, I look into possible direct inputs both from the external crowd of workers and the user who asked the question.
More specifically, the first part of my thesis studies how to combine available unstructured text and structured knowledge base (KB) data for factoid question answering.
In the second part, I build a non-factoid QA system that improves different stages of a pipeline by utilizing available unstructured and semi-structured (\eg question-answer pairs) data.
The next part discusses crowdsourcing for near real-time question answering and studies how to optimize its cost efficiency.
Finally, the last part of my thesis focuses on some aspects of user interactions with the question answering system, and how we can utilize this dialog to improve the success of the information seeking process.
